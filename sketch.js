...
function draw() {
  ...
  fill("white")
  textSize(36)
  text("TREX RUNNER",windowWidth/2-130, windowHeight/2-260)
  textSize(24)
  text("the desert",windowWidth/2-70, windowHeight/2-240)
  
  fill("black")
  textSize(16)
  text("ver 1.10",windowWidth/2+620, windowHeight/2-300)
  text("Trex",trex.x+10, trex.y-40)
